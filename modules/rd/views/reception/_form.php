                        ...
                        <div class="row">
                            <div class="row">
                                <div class="col col-md-10">
                                    <input class="form-control" type="text" id="blCode" name="blCode"  data-parsley-type="digits"  data-parsley-length="[5, 25]" data-parsley-focus="first" placeholder="Código"  data-parsley-trigger="focusin focusout" data-parsley-required="true"/>
